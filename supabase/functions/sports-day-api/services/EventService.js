...
/** Create the EventService adapter with request-scoped dependencies. */
export function createEventService({ Database, ServiceUtilities, services }) {
  /**
   * ==========================================================
   * Sports Day Manager
   *
  ...
  const EventService = {
    ...
    getPointProfile(identifier) {
      return services.PointProfileService.getById(identifier);
    },

    /** Read point profiles through the shared profile service. */
    getPointProfiles() {
      return services.PointProfileService.getAll();
    },
    ...
    createRoundRobinFixtures(eventIdentifier, eventRunIdentifier) {
      ...
      const teams = services.TeamService.getAll();
    ...
    updateMatchWinner(matchIdentifier, winnerIdentifier, eventRunIdentifier) {
      ...
      services.EventRunService.assertCurrent(match.EventID, eventRunIdentifier);
